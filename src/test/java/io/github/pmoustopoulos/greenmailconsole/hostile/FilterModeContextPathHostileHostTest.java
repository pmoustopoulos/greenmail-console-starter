...
/** Filter mode (default) inside the hostile host, under server.servlet.context-path=/api. */
@SpringBootTest(
...
class FilterModeContextPathHostileHostTest extends AbstractHostileHostTest {
    ...
    String expectedBasePath() {
        return "/api/mail-console";
    }

    @Override
    void assertNonLoopbackClientIsRejected() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/mail-console/api/messages");
